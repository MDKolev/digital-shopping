    ...
    <section className="relative bg-hero bg-center bg-no-repeat h-screen w-full">
      <div className="max_padd_container relative top-32 xs:top-52">
        ...
        <p className="text-gray-50 regular-16 mt-6 max-w-[33rem]">
          ...
          totam voluptas deserunt vero, vel deleniti delectus architecto alias,
          minus quisquam similique a dolores voluptatum soluta cumque qui est
          sapiente explicabo. Ducimus, quia hic.
        </p>
